...
|---------------------|--------------------------------|---------------------------------|------------------|
| Discovery dataset, sn 10X multiome    | [Yates et al., 2025](https://www.cell.com/cell-reports-medicine/fulltext/S2666-3791(25)00261-7)    | [Download](https://www.ncbi.nlm.nih.gov/projects/gap/cgi-bin/study.cgi?study_id=phs003438.v1.p1)  |     |
| Discovery dataset, ST 10X Visium and Xenium    | [Yates et al., 2025](https://www.cell.com/cell-reports-medicine/fulltext/S2666-3791(25)00261-7)    | [Download](https://zenodo.org/records/15341263) |  For the H&E images, need to request data from author with proof of IRB approval. |
...
| CellChat database of LR interactinos | python/notebooks/spatial-transcriptomics/8. COMMOT.ipynb | List of ligand receptor interactions of the CellChat database in the right format to run COMMOT | The user should run [ct.pp.ligand_receptor_database(database='CellChat', species='human', signaling_type='Cell-Cell Contact')](https://commot.readthedocs.io/en/latest/api/commot.pp.ligand_receptor_database.html) and  [ct.pp.ligand_receptor_database(database='CellChat', species='human', signaling_type='Secreted Signaling)](https://commot.readthedocs.io/en/latest/api/commot.pp.ligand_receptor_database.html) and save the resulting concatenated dataframes as one csv. NOTE: we use the presaved .csv because the HPC used doesn't have access to the internet. |
